...
<?php 
      ...
      if(isset($_POST['submit'])){
        $filtro = $_POST['myinfo_status'];
        if($filtro == 1){
          $result_livros_busca = "SELECT * FROM livros WHERE nomelivro like '%$_POST[search]%' ";
        }
        else if($filtro == 2){
          $result_livros_busca = "SELECT * FROM livros WHERE autorlivro like '%$_POST[search]%' ";
        }
        else if($filtro == 3){
          $result_livros_busca = "SELECT * FROM livros WHERE categoria like '%$_POST[search]%' ";
        }
        $resultado_livros_busca = mysqli_query($conn,$result_livros_busca);
        $total_livros_busca = mysqli_num_rows($resultado_livros);
      ...
      if($total_livros_busca == 0){
        echo "Ops! Livro não encontrado...Tente procurar novamente";
      } 
        ...
        <div class="row">
            <?php while($rows_livros_busca = mysqli_fetch_assoc($resultado_livros_busca)){ ?>
            <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
            <?php
               $output = '
              <img src="Upload/uploads/'.$rows_livros_busca["img"].'" alt="'.$rows_livros_busca["nomelivro"].'" width="200" height="100" alt="..."/>';
              echo $output;
            ?>
					<div class="caption text-center">
							<a href="detalhes_livro.php?id_livro=<?php echo $rows_livros_busca['idlivros']; ?>"><h3><?php echo $rows_livros_busca['nomelivro']; ?></h3></a>
